/*       
    ...
    de los empleados cuyo salario NO esté comprendido entre 150000 y 200000. */
    ...
    del departamento 20. Además, la consulta debe aparecer ordenada 
    ...
    número de empleado, apellido, oficio y número de departamento. */
